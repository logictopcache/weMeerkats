    ...
    <div className="w-full bg-[#0A1128] min-h-screen">
      <div className="max-w-[1200px] mx-auto px-4 py-5 pb-10">
        <div className="space-y-1 mb-6 pl-2">
          <h2 className="text-2xl md:text-3xl font-bold text-white">Meeting Requests</h2>
          <p className="text-white/60">Manage your pending mentorship meeting requests</p>
        </div>
                ...
                <div className="flex items-start justify-between gap-6 flex-col md:flex-row">
                  ...
                  <div className="flex items-start gap-4 w-full md:w-auto">
                    ...
                    <div className="space-y-2 md:space-y-3 flex-1">
                      <div>
                        <h3 className="text-lg md:text-xl font-semibold text-white">{request.learnerName}</h3>
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-amber-500" />
                          <span className="text-white/60 text-xs md:text-sm">Pending Request</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2 text-white/80">
                          ...
                          <span className="text-xs md:text-sm">
                            {new Date(request.appointmentDateTime).toLocaleDateString('en-US', {
                              weekday: 'long',
                              year: 'numeric',
                              month: 'long',
                              day: 'numeric'
                        ...
                        <div className="flex items-center gap-2 text-white/60">
                          ...
                          <span className="text-xs md:text-sm">
                            {new Date(request.appointmentDateTime).toLocaleTimeString('en-US', {
                              hour: '2-digit',
                              minute: '2-digit'
                            })}
                          </span>
                  ...
                  <div className="flex flex-wrap items-center gap-2 w-full md:w-auto mt-4 md:mt-0">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => handleAccept(request._id, request.appointmentDateTime, request.skill)}
