...
import { FiHome, FiUsers, FiMessageSquare, FiCalendar, FiStar } from "react-icons/fi";
...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { path: "/mentee/calendar", icon: FiCalendar, label: "Appointment Calendar" },
    { path: "/mentee/progress", icon: FiStar, label: "Progress Tracking" },
    { path: "/mentee/learn", icon: FiUsers, label: "Learn from AI" },
    { path: "/mentee/quizapp", icon: FiMessageSquare, label: "Quiz" },
  ];
